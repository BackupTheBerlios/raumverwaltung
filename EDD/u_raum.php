    ...
    <div id="Header">
		...
		<div class="HeaderCols" id="headerBottom">
			...
			<div id="BreadCrumbOuter"><div id="BreadCrumb">
				<div class="tx-fhbobreadcrumb-pi1-menu"><span class="unvisible">Sie sind hier:  </span><!-- InstanceBeginEditable name="siesindhier" --><strong><a href="<?php echo (PHPFILE_LOGGED_IN); ?>" title="Raumverwaltung">Raumverwaltung</a> &#187; <a href="u_raum.php" title="Raum">Raum</a> </strong><!-- InstanceEndEditable --></div>
			</div></div>
			<hr class="dn" />			
		</div>		
	</div>
...
<ul><li><dfn>1.1: </dfn><a href="u_termin.php" title="Termin" class="navi2">Termin<span class="unvisible">. </span></a></li><li><dfn>1.2: </dfn><a href="u_ebene.php" title="Ebene" class="navi2">Ebene<span class="unvisible">. </span></a></li><li><dfn>1.3: </dfn><span class="selected"><strong>Raum<span class="unvisible">. </span></strong></span></li></ul>
